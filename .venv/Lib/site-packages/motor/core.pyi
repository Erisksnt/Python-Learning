...
class AgnosticCollection(AgnosticBaseProperties):
    ...
    async def update_one(
        ...
        hint: Optional[_IndexKeyHint] = None,
        session: Union[
            Optional[AgnosticClientSession], Optional[AgnosticClientSession]
        ] = None,
        let: Optional[Mapping[str, Any]] = None,
        comment: Optional[Any] = None,
    ) -> UpdateResult: ...
...
class AgnosticBaseCursor(AgnosticBase):
    def __init__(
        self,
        cursor: Union[Cursor, CommandCursor, _LatentCursor],
...
class AgnosticLatentCommandCursor(AgnosticCommandCursor):
    __motor_class_name__: str
    def __init__(
        self, collection: AgnosticCollection, start: Any, *args: Any, **kwargs: Any
    ): ...
...
class AgnosticChangeStream(AgnosticBase):
    ...
    def __init__(
        self,
        target: Union[
            pymongo.MongoClient[_DocumentType],
            Database[_DocumentType],
